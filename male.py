...
welcome_label = tkw.Label(window, text="MALE FASHION", font=("Rockwell", 64),  fg="black", opacity=0.7)
...
def button1_click():
    ...
    shirtFolderPath = "Resources/BoysShirt"
...
def button2_click():
    ...
    shirtFolderPath = "Resources/BoysTrouser"
    listShirts = os.listdir(shirtFolderPath)
    # print(listShirts)
    fixedRatio = 262 / 190  # widthOfShirt/widthOfPoint11to12
